...
public class AuctionUpdateRequest {
    ...
    @Schema(description = "경매 시작 시간 (ISO 8601 형식)", requiredMode = Schema.RequiredMode.REQUIRED, example = "2025-08-20T21:00:00+09:00")
    @NotNull
    public OffsetDateTime startTime; // @Future 제거

    @Schema(description = "경매 종료 시간 (ISO 8601 형식)", requiredMode = Schema.RequiredMode.REQUIRED, example = "2025-08-20T22:00:00+09:00")
    @NotNull
    public OffsetDateTime endTime;   // @Future 제거
